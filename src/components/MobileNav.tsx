...
export function MobileNav() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="md:hidden fixed inset-0 z-20 bg-background/95 backdrop-blur-sm pt-20 px-6">
          <nav className="flex flex-col gap-2">
            ...
            <button
              ...
              className="flex items-center gap-3 px-4 py-3 rounded-lg text-lg font-bold text-muted-foreground hover:text-destructive mt-4"
            >
              <LogOut size={20} />
              Sign Out
            </button>
